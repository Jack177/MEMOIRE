...
# level = NULL by default (not written here). This way, the rarefaction use the smallest value of completeness among sites.
 ...
 hill <- estimateD(t(bees), base="coverage") # m is the sample size for the reference level of completeness (we used coverage as completeness metric, thus sample size is not constant)
