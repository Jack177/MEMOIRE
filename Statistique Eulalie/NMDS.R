...
buffertt$layer[buffertt$layer  %in% c("Station_Terril Héribus st1")]<-"Terril de l'H?ribus"
...
buffertt$layer[buffertt$layer  %in% c("Station_Terril Sacré-Français st1")]<-"Terril Sacr?-Fran?ais site 1"
