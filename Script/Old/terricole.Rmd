...
SCS$sites[SCS$site == "Les Gourmandes de la Procession"] <- "Gourmandes"


# Filter les Bombus abondant
#SCS <- filter(SCS, sp != "Terrestribombus  sp." | sp != "Bombus pascuorum" | sp != "Bombus (Bombus)  sp.")
...
# Remplacement du noms de sites
traits$sites[traits$site == "Les Gourmandes de la Procession"] <- "Gourmandes"
```
```{r}
SCS %>%
  group_by(sp, site) %>%
