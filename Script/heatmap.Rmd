...
hm.bee_sp <- gather(hm.bee_sp, key="sp", value="nbr", 2:ncol(hm.data_bee_sp)) # On prend pas la première colonne (site) et on va jusqu'à la dernière colonne (2 à 93) (xylo)
