...
pdf(file = "D:/OneDrive - UMONS/UMONS/MA2/MEMOIRE/Rapport de mémoire/figure/heatmap.pdf",   # The directory you want to save the file in
...
ggplot(hm.bee_sp, aes(x = Site, y = sp, fill = nbr)) +
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0, size = 5, hjust = 0, colour = mycolors),
        axis.text.y = element_text(size = 5, hjust = 0,  vjust = 0.4,face="italic"),
