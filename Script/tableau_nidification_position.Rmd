...
traits$Nest_position[traits$Nest_position == "Underground"] <- "Sous-sol"
```
...
write_xlsx(category_IUCN_fam,"D:/OneDrive - UMONS/UMONS/MA2/MEMOIRE/Statistique/R/STAT-MEMOIRE/Output/sociality.xlsx")
```