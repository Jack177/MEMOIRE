...
mes_estimateurs <- specpool(data_bee_sp)
mes_estimateurs
...
rename(mes_estimateurs, "Espèces observées" = "Species" ) -> estimateurs
rename(estimateurs, "Chao" = "chao" ) -> estimateurs
rename(estimateurs, "Chao ± SE" = "chao.se" ) -> estimateurs
rename(estimateurs, "Jack1" = "jack1" ) -> estimateurs
rename(estimateurs, "Jack1 ± SE" = "jack1.se" ) -> estimateurs
rename(estimateurs, "Jack2" = "jack2" ) -> estimateurs
rename(estimateurs, "Boot" = "boot" ) -> estimateurs
rename(estimateurs, "Boot ± SE" = "boot.se" ) -> estimateurs

# Arrondir à l'unité
estimateurs <- round(estimateurs)
...
write_xlsx(estimateurs,"D:/OneDrive - UMONS/UMONS/MA2/MEMOIRE/Statistique/R/STAT-MEMOIRE/Output/estimateurs.xlsx")
```
