...
ggplot(bee_sp, aes(x = reorder(Specie, -Individual), y =  Individual)) + 
  ...
  theme(axis.title.x = element_text(face="bold", size = 20), # Study site
        ...
        axis.text.x = element_text(face="bold", color= "black", size=10, angle=90, hjust=0), # A C D
        axis.text.y = element_text(face="bold", color= "black", size=10), # 0 100 200 300 400
...
pareto.chart(pareto.bee_sp, cumperc = seq(0, 100, by = 5), 
...
ggplot(hm.bee_sp, aes(x = Site, y = sp, fill = nbr)) +
  labs(title = "Abondance des abeilles sauvages", x = 'Sites', y = 'Espèces') +
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 1, 
                                   size = 8, hjust = 1)) +
  guides(fill = guide_colourbar(title = "Abondance")) +
