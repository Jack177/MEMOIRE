...
```{r}
SCS %>%
  group_by(sp, Site, genus, familly, sociality) %>%
  count(sp) -> df
df$N <- df$n
```
...
sociality <- aggregate(N ~ sp + sociality, data = df, sum)
```
...
sociality_abu$Total <- rowSums(sociality_abu[, c("Cleptoparasite", "Primitivelyeusocial", "Social parasite", "Solitary", "Variable")])
...
# Pourcentage abon Variable
pct_abu_var <- round(sociality_abu[nrow(sociality_abu), "Variable"]/sociality_abu[nrow(sociality_abu), "Total"], 2)


sociality_abu[nrow(sociality_abu) + 1,] = c("Pourcentage", pct_abu_cle,pct_abu_pri,pct_abu_par,pct_abu_sol,pct_abu_var,"")
...
# Ajoute une colonne total
sociality_rich$Total <- rowSums(sociality_rich[, c("Cleptoparasite", "Primitivelyeusocial", "Social parasite", "Solitary", "Variable")])
...
pct_rich_var <- round(sociality_rich[nrow(sociality_rich), "Variable"]/sociality_rich[nrow(sociality_rich), "Total"], 2)

sociality_rich[nrow(sociality_rich) + 1,] = c("Pourcentage", pct_rich_cle,pct_rich_pri,pct_rich_par,pct_rich_sol,pct_rich_var,"")
```
Par genre
```{r}
# Addition des genres avec la socialité
sociality_gen <- aggregate(N ~ genus + sociality, data = df, sum)
```
...
# Ajoute une colonne total
sociality_gen_abu$Total <- rowSums(sociality_gen_abu[, c("Cleptoparasite", "Primitivelyeusocial", "Social parasite", "Solitary", "Variable")])
...
# Pourcentage abon Variable
pct_abu_var <- round(sociality_gen_abu[nrow(sociality_gen_abu), "Variable"]/sociality_gen_abu[nrow(sociality_gen_abu), "Total"], 2)

sociality_gen_abu[nrow(sociality_gen_abu) + 1,] = c("Pourcentage", pct_abu_cle,pct_abu_pri,pct_abu_par,pct_abu_sol,pct_abu_var,"")
...
# Ajoute une colonne total
sociality_gen_rich$Total <- rowSums(sociality_gen_rich[, c("Cleptoparasite", "Primitivelyeusocial", "Social parasite", "Solitary", "Variable")])
...
# Pourcentage rich Variable
pct_rich_var <- round(sociality_gen_rich[nrow(sociality_gen_rich), "Variable"]/sociality_gen_rich[nrow(sociality_gen_rich), "Total"], 2)

sociality_gen_rich[nrow(sociality_gen_rich) + 1,] = c("Pourcentage", pct_rich_cle,pct_rich_pri,pct_rich_par,pct_rich_sol,pct_rich_var,"")
```
